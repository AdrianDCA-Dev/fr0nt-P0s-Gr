   ...
   <!-- <ngx-auth-block>
      ...
      <form (ngSubmit)="register()" #form="ngForm">
        ...
        <div class="form-group">
          ...
          <input name="nombre" [(ngModel)]="user.nombre" id="input-name" #fullName="ngModel"
                 class="form-control" placeholder="Nombre Completo"
                 [class.form-control-danger]="nombre.invalid && nombre.touched"
                 ...
                 autofocus>
          <small class="form-text error" *ngIf="nombre.invalid && nombre.touched && nombre.errors?.required">
            Full name is required!
          </small>
          <small
            class="form-text error"
            *ngIf="nombre.invalid && nombre.touched && (nombre.errors?.minlength || nombre.errors?.maxlength)">
